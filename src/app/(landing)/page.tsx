...
const Page = () => {
  ...
  return (
    <>
              ...
              <MockDiscordUI>
                <AnimatedList>
                  ...
                  <DiscordMessage
                    ...
                    avatarAlt="PingPanda Avatar"
                    username="PingPanda"
                    timestamp="Today at 12:30PM"
                    badgeText="Milestone"
                    badgeColor="#5865f2"
                    title="🚀 Revenue Milestone Achieved"
                    content={{
                      recurringRevenue: "Rs500000",
                      growth: "+15.8%",
                    }}
                  />
                </AnimatedList>
              ...
              <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)] lg:rounded-l-[calc(2rem+1px)]">
                <div className="px-8 pb-3 pt-8 sm:px-10 sm:pb-0 sm:pt-10">
                  ...
                  <p className="mt-2 max-w-lg text-sm/6 text-gray-600 max-lg:text-center">
                    Get instant notifications for sales, new users, or any other
                    event sent directly to your Discord.
                  </p>
                </div>
            ...
            <div className="relative row-span-2">
              ...
              <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)] max-lg:rounded-b-[calc(2rem+1px)] lg:rounded-r-[calc(2rem+1px)]">
                ...
                <div className="relative min-h-[30rem] w-full grow">
                  <div className="absolute right-0 bottom-0 left-10 top-10 overflow-hidden rounded-tl-xl bg-gray-900 shadow-2xl">
      ...
      <section className="relative py-12 sm:py-32 bg-white">
        <MaxWidthWrapper className="flex flex-col items-center gap-16 sm:gap-20">
          <div>
            <h2 className="text-center text-base/7 font-semibold text-brand-600">
          ...
          <div className="mx-auto grid max-w-2xl grid-cols-1 px-4 lg:mx-0 lg:max-w-none lg:grid-cols-2 divide-y lg:divide-y-0 lg:divide-x divide-gray-200">
            ...
            <div className="flex flex-auto flex-col gap-4 bg-brand-25 p-6 sm:p-8 lg:p-16 rounded-t-[2rem] lg:rounded-tr-none lg:rounded-l-[2rem]">
              ...
              <p className="text-base sm:text-lg lg:text-lg/8 font-medium tracking-tight text-brand-950 text-center lg:text-left text-pretty">
                PingPanda has revolutionized our sales process. We&apos;ve been
                able to track customer behavior, identify trends, and optimize
                our marketing efforts with real-time insights.
              </p>
              <div className="flex flex-col justify-center lg:justify-start sm:flex-row items-center sm:items-start gap-4 mt-2">
                ...
                <div className="flex flex-col items-center sm:items-start">
                  ...
                  <p className="text-sm text-gray-600">@itsAlexa</p>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-auto flex-col gap-4 bg-brand-25 p-6 sm:p-8 lg:p-16 rounded-b-[2rem] lg:rounded-bl-none lg:rounded-r-[2rem]">
              ...
              <div className="flex flex-col justify-center lg:justify-start sm:flex-row items-center sm:items-start gap-4 mt-2">
                ...
                <div className="flex flex-col items-center sm:items-start">
                  ...
                  <p className="text-sm text-gray-600">@IamMike</p>
                </div>
              </div>
            </div>
          </div>
